...
## Benchmark
| Model                     | safetensors | fastsafetensors | instanttensor | Notes                                                                                                                                                                                                                                                                      |
|---------------------------|-------------|-----------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Qwen3-32B                 | 14.78s      | 15.53s          | 2.16s         |                                                                                                                                                                                                                                                                            |
| Gemma-4-26B               | 11.73s      | OOM             | 1.78s         | See below for OOM analysis                                                                                                                                                                                                                                                 |
| Gemma-4-26B (TP=2)        | 10.47s      | 5.23s           | 1.76s         |                                                                                                                                                                                                                                                                            |
| GPT-oss-120b (TP=8)       | 29.30s      | 2.54s           | 2.45s         |                                                                                                                                                                                                                                                                            |
| DeepSeek-v4-Flash-0731    | 74.23s      | 17.01s          | 10.01s        |                                                                                                                                                                                                                                                                            |
| Inkling-Small-FP8-Dynamic | N/A         | N/A             | N/A           | Using upstream vLLM 0.27.1 - [Errored](test/models/inkling-small-fp8-dynamic/vllm.log) - ValueError: All MoE projections need to have same quantization scheme but found multiple                                                                                          |
| Inkling-NVFP4 (TP=8)      | 213.18s     | 44.07s          | OOM           | Using upstream vLLM 0.27.1 - OOM after loading weights - H100 also does not support NVFP4 - InstantTensor [OOM while allocating buffer](test/models/inkling-nvfp4/instanttensor-default.log)                                                                               |
| Inkling-Small             | 146.34s     | OOM             | OOM           | Using upstream vLLM 0.27.1. [Fasttensors fails like for Gemma](test/models/inkling-small/fasttensors.log). The shard size is bigger than the available memory after pre-allocation. InstantTensor also fails with OOM when allocating its buffer similar to Inkling-NVFP4. |
